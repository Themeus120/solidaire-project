...
from solidaire_api import exceptions
from solidaire_api.auth.token.serializers import TokenCreateSerializer, TokenRefreshSerializer
from solidaire_api.permissions import AllowAny
