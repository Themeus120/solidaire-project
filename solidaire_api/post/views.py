...
from solidaire_api.permissions import AllowAny, IsAuthenticated
...
class PostMeRetrieveUpdateDestroyView(RetrieveModelMixin, UpdateModelMixin, DestroyModelMixin, PostMeAPIView):
